...
export function LogSleepModal({ open, onClose, onSave, activeSleep, onUpdateSleep }: LogSleepModalProps) {
      ...
      <DialogContent className="max-w-sm mx-auto">
        ...
        <div className="space-y-6">
          ...
          {activeSleep && (
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-blue-800">Sleep in progress</span>
              </div>
              <p className="text-xs text-blue-600 mb-3">
                Started at {activeSleep.startTime.toLocaleTimeString([], { hour: "numeric", minute: "2-digit" })}
              </p>
              <Button
          ...
          <div className="space-y-3">
            ...
            <RadioGroup value={logType} onValueChange={(value: any) => setLogType(value)}>
              <div className="flex items-center space-x-2 p-3 rounded-lg border border-blue-200 bg-blue-50">
                ...
                <Label htmlFor="start" className="flex-1 cursor-pointer">
                  ...
                  <div className="text-xs text-gray-600 mt-1">Baby just fell asleep</div>
                </Label>
              </div>
              <div className="flex items-center space-x-2 p-3 rounded-lg border border-blue-200 bg-blue-50">
                ...
                <Label htmlFor="complete" className="flex-1 cursor-pointer">
                  ...
                  <div className="text-xs text-gray-600 mt-1">Sleep session already finished</div>
                </Label>
              </div>
            </RadioGroup>
          </div>
